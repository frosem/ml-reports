...
describe('SauceDemo - Login Functionality', () => {
  ...
  it('should display error message with invalid credentials', () => {
    LoginPageActions.login(users.invalid.wrongCredentials.username, users.invalid.wrongCredentials.password);
  ...
  it('should display error message with empty username', () => {
    LoginPageActions.enterPassword(users.valid.standard.password);
  ...
  it('should display error message with empty password', () => {
    LoginPageActions.enterUsername(users.valid.standard.username);
    LoginPageActions.clickLoginButton();
  ...
  it('should display error message with locked out user', () => {
    LoginPageActions.login(users.invalid.lockedOut.username, users.invalid.lockedOut.password);
