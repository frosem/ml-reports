...
test.describe(allure.features.checkout.stories.enterShippingInfo, () => {
  ...
  test('TC-038: should enter valid checkout information', async () => {
  ...
  test('TC-039: should validate missing first name', async () => {
  ...
  test('TC-040: should validate missing last name', async () => {
    await severity(Severity.NORMAL);
  ...
  test('TC-041: should validate missing postal code', async () => {
    await severity(Severity.NORMAL);
  ...
  test('TC-042: should cancel checkout', async () => {
    await severity(Severity.NORMAL);
...
test.describe(allure.features.checkout.stories.orderSummary, () => {
  ...
  test('TC-044: should display ordered product items in summary', async () => {
    await severity(Severity.NORMAL);
  ...
  test('TC-053: should display payment and shipping information', async () => {
    await severity(Severity.NORMAL);
...
test.describe(allure.features.checkout.stories.completeOrder, () => {
  test.beforeEach(async () => {
    await subSuite(allure.features.checkout.stories.completeOrder);
    await story(allure.features.checkout.stories.completeOrder);
  });

  test('TC-045: finish button redirects to order confirmation page', async () => {
    await severity(Severity.CRITICAL);
...
test.describe(allure.features.checkout.stories.orderConfirmation, () => {
  test.beforeEach(async () => {
  ...
  test('TC-046: should display order confirmation', async () => {
    await severity(Severity.CRITICAL);
  ...
  test('TC-047: should return to home page after completing an order', async () => {
    await severity(Severity.NORMAL);
  ...
  test('TC-055: order confirmation page shows thank you message', async () => {
    await severity(Severity.NORMAL);
...
test.describe(allure.features.checkout.stories.completeOrder, () => {
  test('TC-078: cart is empty after completing purchase and returning to inventory', async () => {
    await subSuite(allure.features.checkout.stories.completeOrder);
    await story(allure.features.checkout.stories.completeOrder);
    await severity(Severity.CRITICAL);
